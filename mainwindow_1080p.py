...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.setFixedSize(484, 552)
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.grab_btn = QtWidgets.QPushButton(self.centralwidget)
        self.grab_btn.setGeometry(QtCore.QRect(100, 500, 91, 41))
        self.grab_btn.setObjectName("grab_btn")
        self.groupBox = QtWidgets.QGroupBox(self.centralwidget)
        self.groupBox.setGeometry(QtCore.QRect(10, 10, 461, 481))
        self.groupBox.setObjectName("groupBox")
        self.gridLayoutWidget = QtWidgets.QWidget(self.groupBox)
        self.gridLayoutWidget.setGeometry(QtCore.QRect(10, 20, 441, 451))
        ...
        self.save_btn.setGeometry(QtCore.QRect(270, 500, 81, 41))
    ...
    def on_save_btn_clicked(self):
        ...
        QMessageBox.about(self.window, "成功", "已经复制到剪贴板")
